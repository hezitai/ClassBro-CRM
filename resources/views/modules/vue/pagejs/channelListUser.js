var vm = new Vue({
    ...
    methods: {
        ...
        unpassChannelSubmit() {
            ...
            $.ajax({
                url: baseURL + 'sys/TeacChannel/contract/ReviewContract',
                type: 'POST',
                data: {
                    id: this.channelId,
                    desc: this.reason,
        ...
        setChannel: function (row) {
            window.location.href = 'createChannel.html?type=1&id=' + row.id;
        },
        goChannel: function (row) {

            window.location.href = 'createChannel.html?type=2&id=' + row.id;
        },
        checkChannel: function (row) {
            var _this = this;
        ...
        getTableData: function () {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    "page": this.val,
                    "limit": this.limit,
                    "order": 'stcc.create_at desc',
                    "channelName": this.tableDataName,
                    "contractStatus": this.ruleForm.tudStatused
                    // "channelType": this.ruleForm.tudStatused,
                    // "sysUserId": this.toOperId,
                    // "teacType":2,
                },
                url: "" + baseURL + "sys/TeacChannel/contract/list",
        ...
        creatChanne() {
            window.location.href = 'createChannel.html?type=0&id=null';
        },
