        ...
        seedetail(row, index) {
            if (row.sopType == 64) {
                if (row.parentId == null) {
                    window.open("bigClassroomInfo1.html?id=" + row.courseId + "&teacherId=" + row.teacherId);
                } else {
                ...
                success: function (r) {
                    ...
                    if (r.body.studCardBag != null) {
                        var obj1 = {
                            ...
                            money: r.body.studCardBag.addWorth * 1 + r.body.studCardBag
                                .realWorth * 1 - r.body.studCardBag.consumedWorth * 1,
                ...
                success: function (json) {
                    if (json.status == 200) {
                        ...
                        if (json.body.needMoney == 0) {
                            ...
                            vm.ruleForm.dikou = Number(vm.ruleForm1.amount) - Number(json.body
                                .needMoney)
