var Login = {
    ...
    requestLogin: function (account, pwd) {
        ...
        setCookie('crmid', "crm" + crm_number);
        setCookie('crmtoken', token);
        //setCookie('crmid', account.toLocaleLowerCase());
        //自己的appkey就不用加密了
        //setCookie('crmtoken',pwd);
        // if (
        //   window.CONFIG.appkey === '1fe5406367b44a65224e9e2a48e02b80'
        //   //indow.CONFIG.appkey === '39b5b8380a846355afbe1d31f0b83705'
        // ) {
        //   var password = pwd;
        // } else {
        //   password = pwd;
        // }
        // setCookie('crmtoken', password);
