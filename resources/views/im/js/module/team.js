...
YX.fn.team = function () {
	...
	this.$orderInfo.on('click', toSellerDetail.bind(this))
...
var toSellerDetail = function () {
    var teamId = this.crtSessionAccount,
    teamInfo = JSON.parse(this.cache.getTeamById(teamId).serverCustom)
    console.log(teamInfo);
    var courseId = teamInfo.courseId;
    console.log(courseId);
    if(teamInfo.studId == 0){
        var url = redirectURL + "modules/vue/bigClassroomInfo1.html?id=" + courseId;
    } else {
        var url = redirectURL + 'modules/vue/seller_detail.html?id=' + courseId
    }
