...
YX.fn.personInfoEvt = function () {
    ...
    this.$chatContent.delegate('.custom .msg-text', 'click', this.showChat)
    //聊天面板外头像
...
// 从聊天内容点进去
YX.fn.showChat = function (messageId) {
    var messageId = $(this).attr('data-time')
    var type = $(this).attr('data-orderType')
    // window.open("http://www.classbro.com/#/index?messageId="+messageId+"&type="+type+"")
}
